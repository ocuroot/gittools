...
func TestOpen(t *testing.T) {
	SafeTest(t, func(t *testing.T, testDir string) {
...
func TestGetHash(t *testing.T) {
	SafeTest(t, func(t *testing.T, testDir string) {
		// Create a temporary file within the SafeTest directory
		tempFilePath := filepath.Join(testDir, "gittools-test")
		if err := os.WriteFile(tempFilePath, []byte("Hello, world\n"), 0644); err != nil {
		...
		client := Client{}
		hash, err := client.GetHash(tempFilePath)
		if err != nil {
...
func TestFileAtCommit(t *testing.T) {
	SafeTest(t, func(t *testing.T, testDir string) {
		// Create a repository and add the file
		client := Client{}
		repo, err := client.Init(testDir, "main")
		if err != nil {
